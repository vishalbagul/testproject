...
<div id="wrapper">
    ...
    <div id="main">
      ...
      <div id="left_nav">
        ...
        <ul>        	<li class="border" id="active_link"><a href="#">Live Web Sites</a></li>
      ...
      <?php
		...
		while (($row=mysql_fetch_array($res)) !== false)
		{
			...
			$set_time= date('Y:m:d H:i',strtotime('+210 minute'));
		...
		$res3=mysql_query($sql3) or die(mysql_error());
		  ...
		  while (($row3=mysql_fetch_array($res3)) !== false)
			...
			?>
            	...
            	<td id="table_data"><div style="width:500px; height:25px; overflow:hidden;"><a href="<?php echo $row3['url']; ?>" target="_blank" title="<?php print "Public IP-" .$row3['public_ip']. "\n"; print "Local IP-" .$row3['local_ip'];  ?>"><?php echo $row3['url']; ?></a></div></td>                
				<?php
