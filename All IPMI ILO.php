...
<div id="wrapper">
    ...
    <div id="main">
      ...
      <div id="left_nav">
        ...
        <ul>
        	<li class="border" id="active_link"><a href="#">All IPMI / ILO</a></li>
        </ul>
        <div style="background-image:url(images/box-bg.gif); line-height:16px; height:16px;"></div>
      </div> <!-- end left_nav --> 
      <div id="right_main">
      	<h2>All Machines IPMI and ILO</h2>
		<div id="show_table">
      ...
      <?php
		$count_up=0;
		$count_down=0;
		$sql3="SELECT * FROM  `server_ipmi` ORDER BY `server_ipmi`.`name`";
		...
		{
			$sql3="SELECT * FROM  `server_ipmi` ORDER BY `server_ipmi`.`ip`";
		}
