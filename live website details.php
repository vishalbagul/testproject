...
<div id="wrapper">
    ...
    <div id="main">
      ...
      <div id="left_nav">
        ...
        <ul>
        	<li class="border"><a href="All Backup.php">All Backup</a></li>
        ...
        <ul>
			...
			<li class="border" id="active_link"><a href="#">Public and Local IP</a></li>
        </ul>
      ...
      <div id="right_main">
      	<h2>Live Websites Public IP & Local IP</h2>
		<div id="show_table">
      	<table width="100%" style="border-style:solid; border-width:thin; border-color:#999999;">
          <tr>
            <td id="table_head"><a href='?sort=WebsitesName'>Websites Name</a></td>
            <td id="table_head"><a href='?sort=URL'>URL</a></td>
			<td id="table_head"><a href='?sort=PublicIP'>Public IP</a></td>
            <td id="table_head"><a href='?sort=LocalIP'>Local IP</a></td>
          </tr>
      <?php
		$count_up=0;
		$count_down=0;
		...
		$res3=mysql_query($sql3) or die(mysql_error());
		  ...
		  while (($row3=mysql_fetch_array($res3)) !== false)
			...
			?>
				...
				<td id="table_data"><div style="width:400px; height:25px; overflow:hidden;"><a href="<?php echo $row3['url']; ?>"><?php echo $row3['url']; ?></a></div></td>
				<td id="table_data"><div style="height:25px; margin-right:20px;"><?php echo $row3['public_ip']; ?></div></td>
				<td id="table_data"><div style="height:25px; margin-right:20px;"><?php echo $row3['local_ip']; ?></div></td>					
          </tr>
       <?php 
	   	} 
		?>
