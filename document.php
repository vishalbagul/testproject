...
<div id="wrapper">
    ...
    <div id="main">
      <div id="nav"><a href="index.php"><img src="images/home.png" border="0" /></a>&nbsp;&nbsp;<a href="setting.php"><img src="images/setting.png" border="0" /></a>&nbsp;&nbsp;<a href="search.php"><img src="images/search.png" border="0" /></a>&nbsp;&nbsp;<a href="#"><img src="images/documents.png" border="0" /></a></div>
      <div id="left_nav">
      ...
      <div id="right_main">
      	<h2>Documents</h2>
        <div style="width:auto; float:left; margin-left:10%;">
        	<h3 align="left" style="margin-left:20px;">Server Documents</h3>
			<ul>
				<li class="border"><a href="documents/server_location.php">Server Location </a></li>				
			</ul>
            <h3 align="left" style="margin-left:20px;">Network Documents</h3>
			<ul>
				<li class="border"><a href="documents/switch_location.php">Switches Location </a></li>
                <li class="border"><a href="documents/VLANS.php">V-LAN List</a></li>				
			</ul>
            <h3 align="left" style="margin-left:20px;">Website Documents</h3>
			<ul>
				<li class="border"><a href="live website contact details.php">Hosted website Contact Details</a></li>				
			</ul>
